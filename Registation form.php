...
<body style="background-image: url('jasper.jpg'); background-repeat: no-repeat;height: 50%; background-size: cover; margin-top:50px;">
  <?php 
...
<div class="container-fluid"> <!-- Primary Id-->
  <div class="container">
    <div class="row">
      <center><h1><font style="font-family: 'Lucida Handwriting', serif;text-shadow:1px 1px #000;">Create New Account</font></b></h1></center>
