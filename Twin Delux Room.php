...
<body style="margin-top:50px;">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="image/Twin_Delux_Room/img24.jpg"class="d-block w-100" alt="img1">
    </div>

    <div class="item">
      <img src="image/Twin Delux Room/img23.jpg"class="d-block w-100" alt="im2">
    </div>

    <div class="item">
       <img src="image/Twin Delux Room/img25.jpg"class="d-block w-100" alt="im3">
    </div>

    <div class="item">
       <img src="image/Twin Delux Room/img26.jpg"class="d-block w-100" alt="img4">
    </div>

    <div class="item">
       <img src="image/Twin Delux Room/img27.jpg"class="d-block w-100" alt="img5">
    </div>
  </div>
